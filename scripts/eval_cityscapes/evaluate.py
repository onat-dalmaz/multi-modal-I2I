...
#python ./scripts/eval_cityscapes/evaluate.py --cityscapes_dir /datasets/cityscapes/ --result_dir results/cityscapes_pix2pix/test_latest/images/ --output_dir /cityscapes_evaluation/

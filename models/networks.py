...
#         # Layer5-Residual2
#         # model = []
#         model = pac_ResnetBlock(ngf * mult, padding_type=padding_type, norm_layer=norm_layer, use_dropout=use_dropout,
#                                 use_bias=use_bias)
#         setattr(self, 'model_5', model)  # nn.Sequential(*model))
#         ############################################################################################
#         # Layer6-Residual3
#         model = []
#         model = [ResnetBlock(ngf * mult, padding_type=padding_type, norm_layer=norm_layer, use_dropout=use_dropout,
...
#         model = pac_ResnetBlock(ngf * mult, padding_type=padding_type, norm_layer=norm_layer, use_dropout=use_dropout,
#                                 use_bias=use_bias)
#         setattr(self, 'model_8', model)  # nn.Sequential(*model))
#         ############################################################################################
#         # Layer9-Residual6
#         model = []
#         model = [ResnetBlock(ngf * mult, padding_type=padding_type, norm_layer=norm_layer, use_dropout=use_dropout,
...
#         model = pac_ResnetBlock(ngf * mult, padding_type=padding_type, norm_layer=norm_layer, use_dropout=use_dropout,
#                                 use_bias=use_bias)
#         setattr(self, 'model_11', model)  # nn.Sequential(*model))
#         ############################################################################################
#         # Layer12-Residual9
#         model = pac_ResnetBlock(ngf * mult, padding_type=padding_type, norm_layer=norm_layer, use_dropout=use_dropout,
#                                 use_bias=use_bias)
#         setattr(self, 'model_12', model)  # nn.Sequential(*model))
#         ############################################################################################
#         # Layer13-Decoder1
#         i = 0
...
#         x1 = self.netG.model_1(input1)
#         x2 = self.netG.model_2(x1)
#         x3 = self.netG.model_3(x2)
#         x4 = self.netG.model_4(x3)
#         x5 = self.netG.model_5(x4,x4)
#         x6 = self.netG.model_6(x5)
#         x7 = self.netG.model_7(x6)
#         x8 = self.netG.model_8(x7,x4)
#         x9 = self.netG.model_9(x8)
#         x10 = self.netG.model_10(x9)
#         x11 = self.netG.model_11(x10,x2)
#         x12 = self.netG.model_12(x11,x1)
#         x13 = self.netG.model_13(x12)
#         x14 = self.netG.model_14(x13)
#         out = self.netG.model_15(x14)

...
##usage
cd /auto/data2/odalmaz/CVproject/FID_KID/
...
parser.add_argument('--fake_path', type=str,default='/auto/data2/odalmaz/CVproject/CEN/image2image_translation/ckpt/pix2pix_boundary/results/best/fake2/',
                    help=('Path to the generated images or '
                          'to .npz statistic files'))
parser.add_argument('--real_path', type=str,default='/auto/data2/odalmaz/CVproject/CEN/image2image_translation/ckpt/pix2pix_boundary/results/real/',
                    help=('Path to the generated images or '
                          'to .npz statistic files'))
...
if __name__ == '__main__':
    ...
    paths = [os.path.join(args.fake_path ), os.path.join(args.real_path)]
    fid, kid = calculate_given_paths(paths, batch_size=50, cuda=True, dims=2048)
    print('fid: %.3f ,  kid: %.3f'  % (fid, kid))
